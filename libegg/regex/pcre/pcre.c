...
#ifndef VPCOMPAT
#ifdef __cplusplus
extern "C" int   (*_pcre_callout)(pcre_callout_block *) = NULL;
#else
int   (*_pcre_callout)(pcre_callout_block *) = NULL;
#endif
#endif
...
EXPORT int
_pcre_info(const pcre *external_re, int *optptr, int *first_byte)
{
...
EXPORT int
_pcre_fullinfo(const pcre *external_re, const pcre_extra *extra_data, int what,
  void *where)
{
const real_pcre *re = (const real_pcre *)external_re;
...
EXPORT int
_pcre_config(int what, void *where)
{
switch (what)
  {
...
EXPORT pcre *
_pcre_compile(const char *pattern, int options, const char **errorptr,
...
#define RMATCH(rx,ra,rb,rc,rd,re,rf,rg)\
  {\
  heapframe *newframe = (g_malloc)(sizeof(heapframe));\
...
#ifdef NO_RECURSE
heapframe *frame = (g_malloc)(sizeof(heapframe));
...
for (;;)
  ...
  switch(op)
    ...
    if (_pcre_callout != NULL)
      ...
      if ((rrc = (*_pcre_callout)(&cb)) > 0) RRETURN(MATCH_NOMATCH);
    ...
    case OP_RECURSE:
      ...
      if (new_recursive.saved_max <= REC_STACK_SAVE_MAX)
        ...
        new_recursive.offset_save =
          (int *)(g_malloc)(new_recursive.saved_max * sizeof(int));
      ...
      do
        ...
        if (rrc == MATCH_MATCH)
          ...
          if (new_recursive.offset_save != stacksave)
            (g_free)(new_recursive.offset_save);
          RRETURN(MATCH_MATCH);
          }
...
EXPORT int
_pcre_exec(const pcre *external_re, const pcre_extra *extra_data,
...
if (re->top_backref > 0 && re->top_backref >= ocount/3)
  ...
  match_block.offset_vector = (int *)(g_malloc)(ocount * sizeof(int));
...
do
  ...
  if (using_temporary_offsets)
    ...
    (g_free)(match_block.offset_vector);
    }
