...
G_DEFINE_TYPE (TestPrintFileOperation, test_print_file_operation, EGG_TYPE_PRINT_OPERATION)
...
{
  egg_print_operation_set_unit (EGG_PRINT_OPERATION (operation), EGG_UNIT_POINTS);
...
static void
test_print_file_operation_begin_print (EggPrintOperation *operation, EggPrintContext *context)
{
  ...
  height = egg_print_context_get_height (context) - HEADER_HEIGHT - HEADER_GAP;
  ...
  egg_print_operation_set_nr_of_pages (operation, op->num_pages);
}

static void
test_print_file_operation_draw_page (EggPrintOperation *operation,
...
static void
test_print_file_operation_end_print (EggPrintOperation *operation, EggPrintContext *context)
{
  TestPrintFileOperation *op = TEST_PRINT_FILE_OPERATION (operation);
  g_strfreev (op->lines);
}
...
test_print_file_operation_class_init (TestPrintFileOperationClass *class)
{
  ...
  EggPrintOperationClass *print_class = (EggPrintOperationClass *)class;
