...
#include "egg-column-chooser-dialog.h"
...
egg_column_chooser_dialog_init (EggColumnChooserDialog *dialog)
{
	...
	g_object_set_data (G_OBJECT (dialog->tree_view), "foo-data", TRUE);
	...
	gtk_box_pack_start (GTK_BOX (vbox), dialog->move_up_button, FALSE, FALSE, 0);
	...
	gtk_box_pack_start (GTK_BOX (vbox), dialog->move_down_button, FALSE, FALSE, 0);
	...
	gtk_box_pack_start (GTK_BOX (vbox), dialog->show_button, FALSE, FALSE, 0);
	...
	gtk_box_pack_start (GTK_BOX (vbox), dialog->hide_button, FALSE, FALSE, 0);
